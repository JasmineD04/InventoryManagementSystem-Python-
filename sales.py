...
class Sales():
     def __init__(self,root,result):
         ...
         res=self.validate()
         name_var= StringVar()
         self.name_combobox = ttk.Combobox(self.f1, textvariable=name_var,state="readonly")
         ...
         self.quantity_combobox = ttk.Combobox(self.f1, textvariable=quantity_var,state="readonly")
